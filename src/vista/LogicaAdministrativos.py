...
class VentanaAdministrativos(QMainWindow, Form, LogicaCitas):
    ...
    def _on_rol_cambiado(self):
        """Habilita el combo de especialidad solo cuando el rol es Médico."""
    ...
    def _guardar_credencial(self):
        ...
        if exito:
            # val1 = nombre_usuario, val2 = password generada
            ...
            # val1 = mensaje de error, val2 = None
    ...
    def limpiar_formulario_credencial(self):
        """Interfaz pública para que el controlador pueda limpiar el formulario."""
        self._limpiar_credencial()
